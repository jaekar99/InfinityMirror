...
#define NUM_LEDS    107    // how many LEDs you have
...
void loop() {
  ...
  case 0:
    currentPalette = RainbowColors_p;    //Red & Yellow, Fire Colors
    break;
  case 1:
    currentPalette = RainbowColors_p;    //Foresty greens and yellows
    break;
  case 2: 
    currentPalette = RainbowStripeColors_p;  //Oceans are pretty and filled with mermaids
    break;
  case 3: 
